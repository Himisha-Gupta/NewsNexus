...
research_task = Task(
    ...
    expected_output='A comprehensive 3-paragraph long report on the latest trends in {topic}',
    tools=[tool],
...
write_task = Task(
    description=(
        """
        Compose an insightful article on {topic}. Focus on 
        the latest trends and how it’s impacting the industry. This
